...
class LeggedController
    : public controller_interface::MultiInterfaceController<
          HybridJointInterface, hardware_interface::ImuSensorInterface,
 ...
 protected:
  ...
  // bool enable_raw_pub_;
  // vector_t raw_centroidal_state_;  // Raw data: xyz_dot, rpy_dot, xyz, rpy,
  //                                  // JOINT_STATES
  // vector_t raw_inputs_;
  // vector_t raw_motor_states_;
  ...
  ros::Publisher rawDataPublisher_;
